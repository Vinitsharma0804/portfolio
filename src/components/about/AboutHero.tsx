  ...
  return (
    <div className="relative isolate w-full">
      ...
      <div className="w-full">
        <div className="mx-auto px-6 lg:px-8 -mt-4 lg:-mt-24">
          <div className="mx-auto  gap-x-14 lg:mx-0 lg:flex lg:items-center">
            ...
            <div className="mt-14 flex justify-center gap-4 sm:gap-6 md:gap-8 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
                  ...
                  {/* LEFT COLUMN */}
                  <div className="mr-auto w-32 sm:w-40 lg:w-44 flex-none space-y-4 sm:mr-0 sm:pt-52 lg:pt-36">
                    <div className="relative">
                      <img
                        alt="First Image"
                  ...
                  {/* RIGHT COLUMN */}
                  <div className="w-32 sm:w-40 lg:w-44 flex-none space-y-4 pt-32 sm:pt-0">
                    <div className="relative">
                      <img
                        alt=""
